...
public class Reader {
	...
	public static void main(String[] args) throws Exception {
		...
		for (String file : files) {	
			...
			Analizador anal = new Analizador(auxText);

			LinkedList frec = anal.SimpleAndShingle();
			stat.addAnalisis("SimpleAnalyzer + ShingleFilter",frec);
			frec = anal.Simple();
			stat.addAnalisis("SimpleAnalyzer",frec);
			frec = anal.Standard();
			stat.addAnalisis("StandardAnalyzer",frec);
			frec = anal.Custom();
			stat.addAnalisis("CustomAnalyzer",frec);
			frec = anal.JavaAnalyzer();
			stat.addAnalisis("JavaAnalyzer",frec);
			//printList(frec);

			stat.printStatistics(f.getName());
